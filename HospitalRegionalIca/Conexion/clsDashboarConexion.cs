...
namespace HospitalRegionalIca
{
   public  class clsDashboarConexion
    {
        private String CadenaConexion = @"Data Source=SISGALENPLUSHRI;Initial Catalog=SIGH;User ID=Sisgalenplus02;Password=Vannia1419;Connect Timeout=50;"; //sin usuario y contraseña
